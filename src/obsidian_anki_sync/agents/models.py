...
class PreValidationResult(BaseModel):
    ...
    @classmethod
    def strip_quotes_from_error_type(cls, v: str) -> str:
        """Strip extra quotes if LLM returned '"none"' instead of 'none'."""
...
def normalize_enrichment_label(value: str, *, apply_aliases: bool = True) -> str:
...
class EnrichmentAddition(BaseModel):
    ...
    @classmethod
    def _normalize_enrichment_type(cls, value: EnrichmentType | str) -> EnrichmentType:
