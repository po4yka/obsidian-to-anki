...
_register_domain(DomainCriteria(
    name="programming",
    keywords=[
...
_register_domain(DomainCriteria(
    name="medical",
    keywords=[
        "medical", "medicine", "health", "clinical", "pharma", "pharmaceutical",
        "anatomy", "physiology", "pathology", "diagnosis", "treatment", "drug",
        "surgery", "oncology", "cardiology", "neurology", "pediatrics", "radiology",
        "laboratory", "microbiology", "immunology", "pharmacology", "toxicology"
    ],
    quality_checks=[
...
_register_domain(DomainCriteria(
    name="interview",
    keywords=[
        "interview", "job", "career", "behavioral", "technical", "system design",
        "coding interview", "case study", "leadership", "management", "senior",
        "principal", "architect", "consulting", "case interview", "resume", "cv"
    ],
    quality_checks=[
