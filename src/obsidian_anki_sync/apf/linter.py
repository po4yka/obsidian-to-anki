...
ALLOWED_LANGUAGES = {
    'kotlin', 'java', 'python', 'javascript', 'typescript', 'swift',
    'objective_c', 'c', 'cpp', 'rust', 'go', 'dart', 'ruby', 'php',
    'csharp', 'sql', 'yaml', 'json', 'bash', 'powershell', 'docker',
    'kubernetes', 'terraform', 'ansible', 'gradle', 'maven', 'git', 'regex'
}
...
def _validate_manifest(block: str, expected_slug: str, card_num: int, result: ValidationResult) -> None:
...
def _validate_cloze_density(block: str, card_num: int, result: ValidationResult) -> None:
