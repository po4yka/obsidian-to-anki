...
check_content(os.path.join(base_path, "improved_prompts.py"),
              ["Cloze Deletions", "{{c1::", "MathJax", "\\(", "CardType: Cloze", "Special Features"],
              "Improved Prompts")

# 2. card_splitting_prompts.py
print_separator("card_splitting_prompts.py")
check_content(os.path.join(base_path, "card_splitting_prompts.py"),
              ["Cloze Splitting", "{{c1::"],
              "Card Splitting Prompts")

# 3. context_enrichment_prompts.py
print_separator("context_enrichment_prompts.py")
check_content(os.path.join(base_path, "context_enrichment_prompts.py"),
...
check_content(os.path.join(base_path, "memorization_prompts.py"),
